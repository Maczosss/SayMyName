...
public final class User implements Model {
  ...
  public static final QueryField PHONENO = field("phoneno");
  private final @ModelField(targetType="ID", isRequired = true) String id;
  private final @ModelField(targetType="String") String name;
  private final @ModelField(targetType="String") String surname;
  private final @ModelField(targetType="AWSPhone") String phoneno;
  private final @ModelField(targetType="Recording") @HasMany(associatedWith = "user", type = Recording.class) List<Recording> recording = null;
  public String getId() {
      return id;
  }
  ...
  private User(String id, String name, String surname, String phoneno) {
    this.id = id;
    this.name = name;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String surname, String phoneno) {
      super.id(id);
      super.name(name)
        .surname(surname)
        .phoneno(phoneno);
